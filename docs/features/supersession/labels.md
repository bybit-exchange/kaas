...
**21 rulings** of which **sixteen are taken** and V16 needed none, leaving **four open**. See [the verification pass](#independent-verification-pass-2026-08-15). Note
...
**These totals have V1–V13, V19, V20 and V21 applied; 4 rulings are
...
### The queue — 21 items: 17 settled, 4 still needing a ruling
...
call, because each either reclassifies a row or changes what a number means. **V1–V13,
...
basis labelling, and the one that confirmed P10's half-year pair and found the article
blending its two bases into one band — and each row
...
a number are ruled**, and none of the 4 still open moves one: V7 left P3 at 8/5, V8 took
...
the survivors. **V1–V13, V19, V20 and V21 are ruled and applied**, so the
...
two bases rather than as an assertion of v1's figure.
