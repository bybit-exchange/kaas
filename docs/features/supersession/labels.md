...
**21 rulings** of which **fourteen are taken**, leaving **six open**. See [the verification pass](#independent-verification-pass-2026-08-15). Note
...
**These totals have V1–V12, V19, V20 and V21 applied; 5 rulings are
...
article's unlabelled presentation, and — as on P7 — the causal claim narrows to C8. The details are in
...
### The queue — 21 items: 16 settled, 5 still needing a ruling
...
call, because each either reclassifies a row or changes what a number means. **V1–V12,
...
one that closed P2's revival recipe, and the one that re-cut P10's provenance list onto
basis labelling — and each row
...
a number are ruled**, and none of the 5 still open moves one: V7 left P3 at 8/5, V8 took
...
co-source confound to be P7's shape.
...
the survivors. **V1–V12, V19, V20 and V21 are ruled and applied**, so the
