...
**These totals have V1–V10, V12, V19, V20 and V21 applied; 6 rulings are
...
score and makes P2's withdrawal permanent. The details are in
...
### The queue — 21 items: 15 settled, 6 still needing a ruling
...
call, because each either reclassifies a row or changes what a number means. **V1–V10,
V12, V19, V20 and V21 are ruled** — the three that moved the totals, the one
...
then measured what that arm has lost, the one that settled how P5 is reported, and the
one that closed P2's revival recipe — and each row
...
a number are ruled**, and none of the 6 still open moves one: V7 left P3 at 8/5, V8 took
...
the survivors. **V1–V10, V12, V19, V20 and V21 are ruled and applied**, so the
