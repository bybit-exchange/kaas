...
queue stands at **22 rulings** of which **nineteen are taken** and V16 needed none, leaving
**two open**. See [the verification pass](#independent-verification-pass-2026-08-15). Note
...
### The queue — 22 items: 20 settled, 2 still needing a ruling
...
V19–V22 are ruled** — the three that moved the totals, the one
...
supersession, and the one that held P4-C9 on its one v2-exclusive residue — and each row
...
and ruling V22 raised nothing further, so the queue closes at 22. **All three items expected to move
...
rate 27 of 39. **Neither of the 2 items still open can move a number**: both are
keep-the-row items, V17 adding a basis caveat to P10-C5 and V18 recording v1's internal
ambiguity under P4-C3.
